    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                ...
                @endif
                <!-- Form START -->
                <form class="file-upload" action="{{ route('edit.profil.petugas.update', ['id' => $petugas->id]) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="nip" name="nip"
                                            placeholder="NIP"
                                            value="{{ old('nip', auth()->user()->petugas ? auth()->user()->petugas->nip : '') }}">
                                    </div>
                                    <!-- Phone number -->
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" placeholder="Nomor Telepon"
                                            ...
                                            value="{{ old('no_telp', auth()->user()->petugas ? auth()->user()->petugas->no_telp : '') }}">
                                    </div>
                                    <!-- Email -->
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-select" id="gender" name="gender">
                                            ...
                                            <option value="Laki-Laki" @if (auth()->user()->petugas->gender == 'Laki-Laki') selected @endif>
                                                Laki-Laki</option>
                                            <option value="Perempuan" @if (auth()->user()->petugas->gender == 'Perempuan') selected @endif>
                                                Perempuan</option>
                                        </select>
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <textarea class="form-control" id="alamat_petugas" name="alamat_petugas" rows="4"
                                            placeholder="Alamat">{{ auth()->user()->petugas->alamat_petugas }}</textarea>
                                    </div> 
                                </div> <!-- Row END -->
                            </div>
                        </div>
                                    ...
                                    <div class="text-center">
                                        ...
                                        <div class="square position-relative display-2 mb-3">
                                            ...
                                            <input type="hidden" id="oldAvatarPath" name="oldAvatarPath"
                                                value="{{ asset('storage/avatar/' . auth()->user()->petugas->avatar) }}">
                                            <img id="avatarPreview"
                                                src="{{ asset('storage/avatar/' . auth()->user()->petugas->avatar) }}"
